...
pm_caption = f" **\n   \n🔥 {DEFAULTUSER} Ai.God Mode 🔥** \n\n"
pm_caption += "➣ **SYS**                         `នƴន ʀᴜɴɴɪɢ⋆ 🏃`\n"
pm_caption += "➣ **Telethon**                  `₁.₁₅.₀ ` \n"
pm_caption += "➣ **Python**                     `₃.₇.₄ ` \n"
pm_caption += f"➣ **Uptime**                    `{uptime}` \n"
pm_caption += "➣ **Realised By**              @Danuma project\n"
...
pm_caption += "➣ **Copyright**                 [Ai.Userbot](https://github.com/SLdevilX/virtualuserbot)\n"
pm_caption += "➣ **Check **                      `.stat`. \n"
pm_caption += "➣ **Contact Dev**              [Dev](https://lasiya.ml)\n"
